...
![Services in Kubernetes dashboard](Check your services running in the Kubernetes dashboard. ![Services in Kubernetes dashboard]({{site.baseurl}}/res/img/gcp-k8s-dash.jpg))
